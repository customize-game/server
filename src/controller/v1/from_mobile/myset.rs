...
pub async fn get_v1_myset_from_mobile(web::Path(mysets_id): web::Path<u32>) -> impl Responder {
...
pub async fn get_v1_mysets_from_mobile() -> impl Responder {
...
pub async fn register_v1_myset_from_mobile() -> impl Responder {
...
pub async fn update_v1_myset_from_mobile(web::Path(mysets_id): web::Path<u32>) -> impl Responder {
    let mysets_id: Option<u32> = Some(mysets_id);
...
pub async fn delete_v1_myset_from_mobile(web::Path(mysets_id): web::Path<u32>) -> impl Responder {
    let mysets_id: Option<u32> = Some(mysets_id);
