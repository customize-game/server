...
pub async fn get_v1_parameter_chip_from_mobile(web::Path(parameter_chip_id): web::Path<u32>) -> impl Responder {
...
pub async fn get_v1_parameter_chips_from_mobile() -> impl Responder {
