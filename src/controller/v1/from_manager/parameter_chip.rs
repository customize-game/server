...
pub async fn get_v1_parameter_chip_from_manager(web::Path(parameter_chip_id): web::Path<u32>) -> impl Responder {
...
pub async fn get_v1_parameter_chips_from_manager() -> impl Responder {
...
pub async fn register_v1_parameter_chip_from_manager() -> impl Responder {
...
pub async fn update_v1_parameter_chip_from_manager(web::Path(parameter_chip_id): web::Path<u32>) -> impl Responder {
    let parameter_chip_id: Option<u32> = Some(parameter_chip_id);
...
pub async fn delete_v1_parameter_chip_from_manager(web::Path(parameter_chip_id): web::Path<u32>) -> impl Responder {
    let parameter_chip_id: Option<u32> = Some(parameter_chip_id);
