...
pub async fn get_v1_equipment_from_manager(web::Path(equipment_id): web::Path<u32>) -> impl Responder {
...
pub async fn get_v1_equipments_from_manager() -> impl Responder {
...
pub async fn register_v1_equipment_from_manager() -> impl Responder {
...
pub async fn update_v1_equipment_from_manager(web::Path(equipment_id): web::Path<u32>) -> impl Responder {
    let equipment_id: Option<u32> = Some(equipment_id);
...
pub async fn delete_v1_equipment_from_manager(web::Path(equipment_id): web::Path<u32>) -> impl Responder {
    let equipment_id: Option<u32> = Some(equipment_id);
