...
pub async fn get_one(web::Path(hoge_interface_id): web::Path<u32>) -> impl Responder {
...
pub async fn update(web::Path(hoge_interface_id): web::Path<u32>) -> impl Responder {
    let hoge_interface_id: Option<u32> = Some(hoge_interface_id);
...
pub async fn delete(web::Path(hoge_interface_id): web::Path<u32>) -> impl Responder {
    let hoge_interface_id: Option<u32> = Some(hoge_interface_id);
